    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                ...
                viewHolder.tvDeviceData = (TextView) view.findViewById(R.id.tv_device_data);
            ...
            if (deviceName != null && deviceName.length() > 0) {
                viewHolder.deviceName.setText("设备名：" + deviceName);
            } else {
                viewHolder.deviceName.setText(R.string.unknown_device);
            }
            viewHolder.deviceAddress.setText("MAC地址：" + device.getAddress());
            viewHolder.tvDeviceData.setText(Arrays.toString(scanRecord));
            viewHolder.tvDistance.setText(String.valueOf(mDistance.get(i)));
            viewHolder.tvRssi.setText(String.valueOf(mRssi.get(i)));
            return view;
        }
    }
            ...
            new BluetoothAdapter.LeScanCallback() {
                ...
                public void onLeScan(final BluetoothDevice device, final int rssi, final byte[] scanRecord) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            mLeDeviceListAdapter.addDevice(device, scanRecord, rssi,RssiUtil.getDistance(rssi));
